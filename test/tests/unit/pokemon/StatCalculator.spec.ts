...
describe('StatCalculator', () => {
  it('gives a lowest HP of 11', () => {
    let hp = StatCalculator.calculate(StatType.HIT_POINTS, 0, 0, 0, 1, Nature.ADAMANT);
    expect(hp).to.equal(11);
  });

  it('gives a lowest Attack of 4', () => {
    let attack = StatCalculator.calculate(StatType.ATTACK, 0, 0, 0, 1, Nature.CALM);
  ...
  describe('working on a Level 78 Garchomp', () => {
    ...
    it('calculates the correct HP', () => {
      let hp = StatCalculator.calculate(
    ...
    it('calculates the correct Attack', () => {
      let attack = StatCalculator.calculate(
    ...
    it('calculates the correct Special Attack', () => {
      let specialAttack = StatCalculator.calculate(
    ...
    it('calculates the correct Speed', () => {
      let speed = StatCalculator.calculate(
