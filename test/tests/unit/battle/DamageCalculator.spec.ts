...
describe('DamageCalculator', () => {
  ...
  describe('a level 75 Glaceon using Ice Fang against a Garchomp', () => {
    // TODO: Add example from here https://bulbapedia.bulbagarden.net/wiki/Damage#Damage_calculation
  });
